...
total_found += len(re.findall(search, horizontal)) + len(re.findall(search, horizontal[::-1]))
...
total_found += len(re.findall(search, vertical)) + len(re.findall(search, vertical[::-1]))
...
total_found += len(re.findall(search, horizontal_d)) + len(re.findall(search, horizontal_d[::-1]))

word_search_rotated_d = get_diagonals(word_search_rotated)
vertical_d = " ".join(word_search_rotated_d)
total_found += len(re.findall(search, vertical_d)) + len(re.findall(search, vertical_d[::-1]))
